    ...
    <div id="login">
        <div>
            <div class="login">
                <h1>Login Admin</h1>
                <div>
                    <input type="text" name="u" placeholder="Username"  v-model="account"/>
                    <input type="password" name="p" placeholder="Password"  v-model="password"/>
                    <button type="submit" class="btn btn-primary btn-block btn-large" @click="login">let me login.</button>
                </div>
            </div>
        </div>
<!--        <label for="">账号</label>-->
